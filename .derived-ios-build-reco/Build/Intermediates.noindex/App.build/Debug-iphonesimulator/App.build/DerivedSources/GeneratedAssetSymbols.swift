...
extension ImageResource {
    ...
    static let launchBrand = ImageResource(name: "LaunchBrand", bundle: resourceBundle)

    /// The "PromoSpringMan" asset catalog image resource.
    static let promoSpringMan = ImageResource(name: "PromoSpringMan", bundle: resourceBundle)

    /// The "PromoSpringShoes" asset catalog image resource.
    static let promoSpringShoes = ImageResource(name: "PromoSpringShoes", bundle: resourceBundle)
