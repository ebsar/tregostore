...
function normalizeNotificationPayload(event) {
  ...
  try {
    ...
    return {
      ...
      href: String(payload.href || payload.path || payload?.data?.href || "/tabs/account/notifications"),
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title, {
      ...
      data: {
        ...payload.data,
        href: payload.href || "/tabs/account/notifications",
      },
...
self.addEventListener("notificationclick", (event) => {
  ...
  const targetHref = String(event.notification?.data?.href || "/tabs/account/notifications");
